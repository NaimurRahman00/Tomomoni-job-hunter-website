      ...
      <div className="flex flex-col mt-6">
        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div className="overflow-hidden border border-gray-500 md:rounded-lg bg-zinc-800">
              <table className="min-w-full divide-y divide-gray-200/50 bg-zinc-800">
                ...
                <tbody className="bg-zinc-800 divide-y divide-gray-200/20 ">
                  <tr>
                    ...
                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                      <div className="flex items-center gap-x-2">
                        <p
                          className="px-3 py-1 rounded-full text-black bg-blue-100/60
                           text-xs"
                        >
                          Web Development
                        </p>
